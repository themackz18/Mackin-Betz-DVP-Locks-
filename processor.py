...
def run_daily_scrape():
    try:
        if not os.path.exists(FALLBACK_CSV):
            raise FileNotFoundError(f"Missing CSV file at {FALLBACK_CSV}. Please upload your CSV there.")
        ...
        logger.info("✅ Report and cheatsheet generated successfully from CSV")
        return report
    except Exception as e:
